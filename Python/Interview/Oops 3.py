...
# 1️⃣ Public Access Specifier - access from everywhere - name
class Student:
    def __init__(self):
        self.name = "Ankit"   # Public variable
    def show(self):
        print("Name:", self.name)
obj = Student()
obj.show() # Access inside class
print(obj.name) # Access outside class
# Name: Ankit
# Ankit

# 2️⃣ Protected Access Specifier - access from class and child class - _name
class Parent:
    def __init__(self):
        self._name = "Ankit"   # Protected variable
class Child(Parent):
    def display(self):
        print("Name:", self._name)
obj = Child()
obj.display()
print(obj._name) # Can still be accessed outside (not recommended)
# Name: Ankit
# Ankit

# 3️⃣ Private Access Specifier - access from in same class - __name
class Student:
    def __init__(self):
        self.__name = "Ankit"   # Private variable
    def show(self):
        print("Name:", self.__name)
obj = Student()
obj.show() # Access inside class
# print(obj.__name)   # Error # Access outside class
# Name: Ankit
